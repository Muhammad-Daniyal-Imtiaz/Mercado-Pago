  ...
  return (
    <div className="relative w-full max-w-md mx-auto p-8 bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800">
      ...
      {showRoleModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-900/80 backdrop-blur-md animate-in fade-in duration-300">
          <div className="w-full max-w-sm bg-white dark:bg-zinc-900 rounded-[2.5rem] p-10 shadow-2xl border border-zinc-200 dark:border-zinc-800 animate-in zoom-in-95 duration-200">
            <h2 className="text-3xl font-black mb-2 text-zinc-900 dark:text-white uppercase tracking-tighter leading-none text-center">Your Role</h2>
            <p className="text-zinc-500 text-sm mb-8 font-medium italic text-center">If you're new, select your role before Google login.</p>
            ...
            <div className="grid grid-cols-1 gap-4 mb-10">
              ...
              <button 
                ...
                className="group p-6 text-left rounded-3xl border-2 border-zinc-100 dark:border-zinc-800 hover:border-zinc-900 dark:hover:border-white transition-all bg-zinc-50 dark:bg-zinc-950 shadow-sm"
              >
                <div className="font-black text-zinc-900 dark:text-white text-xl group-hover:translate-x-1 transition-transform uppercase">Regular User</div>
                <div className="text-xs text-zinc-500 font-bold uppercase tracking-widest mt-1 opacity-60">Standard Team Member</div>
              </button>
            </div>
      ...
      <div className="text-center mb-10">
        <h1 className="text-3xl font-black tracking-tighter text-zinc-900 dark:text-zinc-100 uppercase">Welcome back</h1>
        <p className="mt-2 text-zinc-500 dark:text-zinc-400 font-medium text-sm">Enter workspace credentials</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="relative py-4">
          ...
          <div className="relative flex justify-center text-xs font-black uppercase"><span className="px-4 bg-white dark:bg-zinc-900 text-zinc-400 tracking-widest">Secure OAuth</span></div>
        </div>

        <button
          type="button"
          onClick={() => setShowRoleModal(true)}
          className="w-full py-4 bg-white dark:bg-zinc-950 border-2 border-zinc-100 dark:border-zinc-800 text-zinc-900 dark:text-white font-black rounded-xl hover:border-zinc-900 dark:hover:border-white flex items-center justify-center gap-3 transition-all shadow-lg"
        >
