...
export default function InviteFormEn() {
    ...
    return (
      <div className="w-full flex items-center justify-center p-12 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800">
        <div className="flex flex-col items-center space-y-3">
          ...
          <span className="text-sm font-black uppercase tracking-widest text-zinc-400">Loading teams...</span>
        </div>
      </div>
    )
  }
  ...
  if (organizations.length === 0) {
    return (
      <div className="w-full p-8 rounded-2xl bg-zinc-50 dark:bg-zinc-900 border-2 border-dashed border-zinc-300 dark:border-zinc-800 text-center space-y-4 flex flex-col justify-center min-h-[300px]">
        <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2 tracking-tighter uppercase">No teams found</h3>
        <p className="text-zinc-500 text-sm max-w-xs mx-auto">
          You must create at least one team before inviting new members.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="w-full p-5 sm:p-8 bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 transition-all">
      <h2 className="text-xl sm:text-2xl lg:text-3xl font-black mb-4 sm:mb-6 text-zinc-900 dark:text-white tracking-tighter uppercase"><User className="inline-block w-6 h-6 sm:w-8 sm:h-8 mr-2" /> Invite User</h2>
