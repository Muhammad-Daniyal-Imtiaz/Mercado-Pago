-- SOLUCIÓN SEGURA PARA PRODUCCIÓN - Sin romper políticas RLS
-- Ejecutar en producción paso a paso

-- PASO 1: Primero, ver qué políticas usan get_user_role
SELECT 
    schemaname,
    tablename,
    policyname,
...
-- PASO 2: Crear una nueva función mejorada que reemplace a get_user_role
